...
$endpoint="http://localhost/appwebOS/parcial2/api_restful/controllers/usuario.php?op=selectall";
    ...
    <center>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="table-warning"><?php echo $datos[$i]['user']?></td>
                <td class="table-warning"><?php echo $datos[$i]['pwd']?></td>
                <td class="table-warning"><?php echo $datos[$i]['privilegio']?></td>
